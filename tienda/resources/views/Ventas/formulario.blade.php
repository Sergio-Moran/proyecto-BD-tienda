...
<div class="form-row form-row shadow-md bg-auto rounded-lg" style="margin: 2ch; padding: 2ch">
    <div class="grid grid-cols-2 gap-4">
        ...
        <select  wire:change="$emit('producto-cambiado')" class="input input-bordered" name="cod_producto_fk" id="descripcion" option="Medida">
...
<div class="grid grid-cols-1 md:grid-cols-1 gap-3 mt-5" style="margin: 2ch">
    <a class="btn btn-outline btn-success" href="{{ url('/Ventas/' . $id . '/vendido') }}" class="mb-10">Confirmar Compra</a>
</div>
<div class="grid grid-cols-1 md:grid-cols-1 gap-3 mt-5" style="margin: 2ch">
    <a class="btn btn-outline btn-error" href="{{ url('/Ventas/' . $id . '/destroy') }}" class="mb-10">Eliminar Compra</a>
</div>